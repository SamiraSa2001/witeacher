...
def create_parser():
    ...
    parser.add_argument('--dataset', metavar='DATASET', default='ourData200x30',
                        choices=datasets.__all__,
                        help='dataset: ' +
                            ' | '.join(datasets.__all__) +
                            ' (default: ourData200x30)')
    ...
    parser.add_argument('--labels', default='./data-local/labels/ourDataLabel/LeaveUser3/00.txt', type=str, metavar='FILE',
    ...
    parser.add_argument('--labeled-batch-size', default=177, type=int,
                        metavar='N', help="labeled examples per minibatch (default: no constrain)")
    parser.add_argument('--labeled-batch-size_gan', default=10, type=int,
                        metavar='N', help="labeled examples per minibatch (default: no constrain)")
